...
crosslingual = [
    (25.65, 21.76, "Exp 1: Cross-lingual\n(Tamil/Yoruba/Welsh/Code)", "#c0392b", "*"),
]
...
moe_ppl    = [7.7,  22.1,  3.0, 8.1]   # seeds 137/2026 (perfect routing)
spec_ppl   = [7.7,  22.1,  3.0, 8.1]   # MoE = spec (perfect routing)
...
for i, imp in enumerate(improvements):
    ax.text(i, base_ppl[i] + 1.5, imp, ha='center', fontsize=9, fontweight='bold', color='#c0392b')

ax.set_xticks(x)
ax.set_xticklabels(domains, fontsize=11)
ax.set_ylabel("Perplexity (lower = better)", fontsize=11)
ax.set_title("KALAVAI Cross-Lingual Fusion (Exp 1): Pythia-410M\nMoE matches specialist on all domains simultaneously", fontsize=11, fontweight='bold')
ax.legend(fontsize=9)
ax.set_ylim(0, 115)
ax.text(0, -12, "Seeds 137 & 2026 (perfect routing). Seed 42 had router collapse on Yoruba (see §4.8.2).",
