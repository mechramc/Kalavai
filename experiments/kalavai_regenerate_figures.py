...
"""
Regenerate ALL KALAVAI publication figures from existing JSON results.
...
try:
    ...
    fig, ax = plt.subplots(figsize=(5, 4))
    # Green shaded KALAVAI target zone (0–20%)
...
try:
    ...
    # Qwen data point at -1.0% improvement (not a KALAVAI result — shown as reference)
...
try:
    ...
    fig.suptitle("KALAVAI: Cooperative MoE Fusion — Key Results", fontsize=13, y=1.01)
    fig.tight_layout(pad=1.5)
