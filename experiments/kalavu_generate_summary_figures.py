...
NOTE: Re-run with 2.8B data once kalavu_pythia_2b_experiment.py completes
...
ax.set_title(f"KALAVU Fusion at Scale: Pythia-6.9B\n"
...
# NOTE: Add 2.8B data point here once kalavu_pythia_2b_experiment.py completes.
...
ax.set_title("KALAVU Scale Ladder: Fusion Benefit vs Model Size\n"
