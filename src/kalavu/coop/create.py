"""End-to-end cooperative creation for Kalavu.
...
from kalavu.coop.calibration import generate_calibration_batch
from kalavu.coop.manifest import generate_manifest
from kalavu.coop.reference import compute_cka_reference
from kalavu.coop.seed import generate_seed_checkpoint
from kalavu.coop.tokenizer import save_tokenizer, train_tokenizer
...
def create_cooperative(
    ...
    Steps:
        1. Save ``kalavu.yaml`` configuration
    ...
    # ── Step 1: Save config ────────────────────────────────────────────
    config_path = output_dir / "kalavu.yaml"
    console.print("[bold cyan][1/6][/] Saving kalavu.yaml...")
