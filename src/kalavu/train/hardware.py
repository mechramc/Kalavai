"""Hardware auto-detection for Kalavu training.

Detects CUDA GPU availability and reports device name, VRAM, and CUDA version
as a structured dataclass. Used by `kalavu train start` to auto-configure
training parameters.
"""
...
from kalavu.core.exceptions import HardwareError
...
def detect_hardware() -> HardwareInfo:
    ...
    if not torch.cuda.is_available():
        raise HardwareError(
            "No CUDA GPU detected. Kalavu requires a CUDA-capable GPU for training. "
